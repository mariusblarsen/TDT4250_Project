...
class GpxCustomGenerator {
	...
	def static void generateProject(Project project, StringBuilder stringBuilder) {
		stringBuilder << 
		'''<project name="«project.name»" company="" webLink="http://" view-date="2021-01-01" view-index="0" gantt-divider-location="367" resource-divider-location="300" version="2.8.11" locale="en_US">''' <<
		"<description/>"
